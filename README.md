...
**IDA LIB (Image Data Augmentation Library)** es una librería escrita en Python para el *Image Data Augmentation* de manera eficiente, rápida y sencilla. Ida Lib permite la realización de gran variedad de operaciones para dotar de la mayor diversidad posible al dataset de entrada. 
